...
const Crud = () => {
    ...
    const leftToolbarTemplate = () => {
        return (
            <React.Fragment>
                <div className="my-2">
                    <Button label="Novo" icon="pi pi-plus" severity="sucess" className="mr-2" onClick={openNew} />
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    >
                        ...
                        <Column field="name" header="Sigla" sortable body={nameBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
